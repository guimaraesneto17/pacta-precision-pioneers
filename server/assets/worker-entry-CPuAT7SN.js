...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DKJwui8R.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BnEM0R4D.js").then((n2) => n2.x),
...
var ROUTER_BASEPATH = "pacta-precision-pioneers";
var SERVER_FN_BASE = "/pacta-precision-pioneers/_serverFn/";
